...
{
    /// <summary>
    /// A RefSeq FASTA identifier.
    /// </summary>
    public sealed class RefSeqIdentifier : Identifier
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RefSeqIdentifier"/> class.
        /// </summary>
        ...
        /// </exception>
        public RefSeqIdentifier(string accession, string name) : base(Constants.Codes.RefSeq)
        {
            if (accession == null)
            {
