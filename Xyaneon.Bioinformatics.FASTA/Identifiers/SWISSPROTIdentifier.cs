...
{
    /// <summary>
    /// A SWISS-PROT FASTA identifier.
    /// </summary>
    public sealed class SWISSPROTIdentifier : Identifier
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SWISSPROTIdentifier"/> class.
        /// </summary>
        ...
        /// </exception>
        public SWISSPROTIdentifier(string accession, string name) : base(Constants.Codes.SWISSPROT)
        {
            if (accession == null)
            {
