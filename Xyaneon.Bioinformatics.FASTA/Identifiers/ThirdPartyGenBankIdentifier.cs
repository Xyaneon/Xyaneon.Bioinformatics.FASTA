...
{
    /// <summary>
    /// A third-party GenBank FASTA identifier.
    /// </summary>
    public sealed class ThirdPartyGenBankIdentifier : Identifier
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ThirdPartyGenBankIdentifier"/> class.
        /// </summary>
        ...
        /// </exception>
        public ThirdPartyGenBankIdentifier(string accession, string name) : base(Constants.Codes.ThirdPartyGenBank)
        {
            if (accession == null)
            {
