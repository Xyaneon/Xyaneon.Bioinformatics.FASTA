...
{
    /// <summary>
    /// A third-party DDBJ FASTA identifier.
    /// </summary>
    public sealed class ThirdPartyDDBJIdentifier : Identifier
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ThirdPartyDDBJIdentifier"/> class.
        /// </summary>
        ...
        /// </exception>
        public ThirdPartyDDBJIdentifier(string accession, string name) : base(Constants.Codes.ThirdPartyDDBJ)
        {
            if (accession == null)
            {
