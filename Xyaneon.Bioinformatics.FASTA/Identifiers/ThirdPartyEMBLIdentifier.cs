...
{
    /// <summary>
    /// A third-party EMBL FASTA identifier.
    /// </summary>
    public sealed class ThirdPartyEMBLIdentifier : Identifier
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ThirdPartyEMBLIdentifier"/> class.
        /// </summary>
        ...
        /// </exception>
        public ThirdPartyEMBLIdentifier(string accession, string name) : base(Constants.Codes.ThirdPartyEMBL)
        {
            if (accession == null)
            {
